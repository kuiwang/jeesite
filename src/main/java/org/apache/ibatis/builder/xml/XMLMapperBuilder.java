...
public class XMLMapperBuilder extends BaseBuilder {
    ...
    public XMLMapperBuilder(InputStream inputStream, Configuration configuration, String resource,
        ...
        this(new XPathParser(inputStream, true, configuration.getVariables(),
                new XMLMapperEntityResolver()), configuration, resource, sqlFragments);
    }
    ...
    private ResultMapping buildResultMappingFromContext(XNode context, Class<?> resultType,
        ...
        return builderAssistant.buildResultMapping(resultType, property, column, javaTypeClass,
                ...
                typeHandlerClass, flags, resulSet, foreignColumn, lazy);
    }
        ...
        for (XNode parameterMapNode : list) {
            ...
            for (XNode parameterNode : parameterNodes) {
                ...
                ParameterMapping parameterMapping = builderAssistant.buildParameterMapping(
                        parameterClass, property, javaTypeClass, jdbcTypeEnum, resultMap, modeEnum,
                        typeHandlerClass, numericScale);
