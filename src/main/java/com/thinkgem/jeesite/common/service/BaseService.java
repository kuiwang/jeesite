...
public abstract class BaseService {
     ...
     *          "id=a.create_by"); dataScopeFilter(entity, "dsf",
     *          "code=a.jgdm", "no=a.cjr"); //
     *          适应于业务表关联不同字段时使用，如果关联的不是机构id是code。
     */
    public static void dataScopeFilter(BaseEntity<?> entity, String sqlMapKey, String officeWheres,
            String userWheres) {
            ...
            for (Role r : user.getRoleList()) {
                for (String oa : org.apache.commons.lang3.StringUtils.split(officeAlias, ",")) {
                    if (!dataScope.contains(r.getDataScope())
                            && org.apache.commons.lang3.StringUtils.isNotBlank(oa)) {
