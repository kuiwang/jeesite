...
public class JedisSessionDAO extends AbstractSessionDAO implements SessionDAO {
    ...
    public Collection<Session> getActiveSessions(boolean includeLeave, Object principal,
        ...
        try {
            ...
            for (Map.Entry<String, String> e : map.entrySet()) {
                if (org.apache.commons.lang3.StringUtils.isNotBlank(e.getKey())
                        && org.apache.commons.lang3.StringUtils.isNotBlank(e.getValue())) {
    ...
    public void update(Session session) throws UnknownSessionException {
        ...
        if (request != null) {
            ...
            // 如果是视图文件，则不更新SESSION
            if (org.apache.commons.lang3.StringUtils.startsWith(uri,
                    Global.getConfig("web.view.prefix"))
                    && org.apache.commons.lang3.StringUtils.endsWith(uri,
        ...
        try {
            ...
            jedis.set(JedisUtils.getBytesKey(sessionKeyPrefix + session.getId()),
