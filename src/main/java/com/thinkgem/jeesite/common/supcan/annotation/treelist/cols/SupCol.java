...
public @interface SupCol {
    ...
    /**
     * 是否隐藏, true - 隐藏() default ""; false - 显示() default ""; absHide 或
     * absTrue - 绝对隐藏，不会被鼠标右键菜单选择() default ""; absShow 或 absFalse -
     * 绝对显示，不会被鼠标右键菜单选择() default "";
     */
    ...
    /**
     * VColSepStyle 虚拟列的合并方式 row - 只允许跨行的垂直合并() default ""; col -
     * 只允许跨列的横向合并() default ""; row,col - 跨行、跨列自动合并() default "";
     */
