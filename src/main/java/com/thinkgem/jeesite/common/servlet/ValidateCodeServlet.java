...
public class ValidateCodeServlet extends HttpServlet {
    ...
    private String createCharacter(Graphics g) {
        char[] codeSeq = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'J', 'K', 'M', 'N', 'P', 'Q',
        ...
        for (int i = 0; i < 4; i++) {
            ...
            g.setColor(new Color(50 + random.nextInt(100), 50 + random.nextInt(100), 50 + random
                    .nextInt(100)));
    ...
    private Color getRandColor(int fc, int bc) {
        ...
        return new Color(f + random.nextInt(b - f), f + random.nextInt(b - f), f
                + random.nextInt(b - f));
    }
