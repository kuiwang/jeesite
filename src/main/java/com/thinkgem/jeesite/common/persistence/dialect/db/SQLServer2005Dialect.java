...
public class SQLServer2005Dialect implements Dialect {
     ...
     * CURRENT_TIMESTAMP) as __row_number__, * from table_name) SELECT *
     * FROM query WHERE __row_number__ BETWEEN :offset and :lastRows ORDER
     * BY __row_number__
     *
     * @param querySqlString The SQL statement to base the limit query off
     *        of.
