...
public class ArticleService extends CrudService<ArticleDao, Article> {
    ...
    public Page<Article> findPage(Page<Article> page, Article article, boolean isDataScopeFilter) {
        ...
        if ((updateExpiredWeightDate == null)
                || ((updateExpiredWeightDate != null) && (updateExpiredWeightDate.getTime() < new Date()
                        .getTime()))) {
    ...
    public void save(Article article) {
        if (article.getArticleData().getContent() != null) {
            article.getArticleData().setContent(
                    StringEscapeUtils.unescapeHtml4(article.getArticleData().getContent()));
        }
     ...
     */
    //FIXME 暂不提供检索功能
    public Page<Article> search(Page<Article> page, String q, String categoryId, String beginDate,
            String endDate) {
