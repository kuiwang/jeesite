...
public class SiteController extends BaseController {
    ...
    public String delete(Site site, @RequestParam(required = false) Boolean isRe,
    ...
    public String list(Site site, HttpServletRequest request, HttpServletResponse response,
            Model model) {
