...
public class CmsUtils {
     ...
     * @return ${fnc:getArticleList(category.site.id, category.id, not
     *         empty pageSize?pageSize:8, 'posid:2, orderBy:
     *         \"hits desc\"')}"
     */
    public static List<Article> getArticleList(String siteId, String categoryId, int number,
            String param) {
     ...
     */
    public static List<Category> getCategoryList(String siteId, String parentId, int number,
            String param) {
    ...
    public static List<Category> getMainNavList(String siteId) {
        ...
        List<Category> mainNavList = (List<Category>) CacheUtils.get(CMS_CACHE, "mainNavList_"
                + siteId);
        if (mainNavList == null) {
            Category category = new Category();
            category.setSite(new Site(siteId));
