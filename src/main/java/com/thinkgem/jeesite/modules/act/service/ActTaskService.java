...
public class ActTaskService extends BaseService {
     ...
     */
    @Transactional(readOnly = false)
    public void complete(String taskId, String procInsId, String comment, String title,
     ...
     * @param vars
     */
    public void completeFirstTask(String procInsId, String comment, String title,
            Map<String, Object> vars) {
        String userId = UserUtils.getUser().getLoginName();
        Task task = taskService.createTaskQuery().taskAssignee(userId).processInstanceId(procInsId)
                .active().singleResult();
        if (task != null) {
    ...
    public List<Act> histoicFlowList(String procInsId, String startAct, String endAct) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            // 过滤开始节点前的节点
            if (org.apache.commons.lang3.StringUtils.isNotBlank(startAct)
            ...
            if (org.apache.commons.lang3.StringUtils.isNotBlank(histIns.getAssignee())
                ...
                if ("startEvent".equals(histIns.getActivityType())) {
                    List<HistoricProcessInstance> il = historyService
                            .createHistoricProcessInstanceQuery().processInstanceId(procInsId)
                    ...
                    if (il.size() > 0) {
                        if (org.apache.commons.lang3.StringUtils.isNotBlank(il.get(0)
                                .getStartUserId())) {
            ...
            // 过滤结束节点后的节点
            if (org.apache.commons.lang3.StringUtils.isNotBlank(endAct)
                ...
                for (int j = i + 1; j < list.size(); j++) {
                    ...
                    if (((actNumA != null) && (actNumA < actNum))
                            || org.apache.commons.lang3.StringUtils.equals(hi.getActivityId(),
    ...
    public Page<Act> historicList(Page<Act> page, Act act) {
        ...
        // 查询列表
        List<HistoricTaskInstance> histList = histTaskQuery.listPage(page.getFirstResult(),
                page.getMaxResults());
    ...
    private Map<String, Object> packageSingleActivitiInfo(ActivityImpl activity,
            ProcessInstance processInstance, boolean currentActiviti) throws Exception {
    ...
    private void setCurrentTaskAssignee(Map<String, Object> vars, Task currentTask) {
        ...
        if (assignee != null) {
            org.activiti.engine.identity.User assigneeUser = identityService.createUserQuery()
    ...
    private void setTaskGroup(Map<String, Object> vars, Set<Expression> candidateGroupIdExpressions) {
        ...
        for (Expression expression : candidateGroupIdExpressions) {
            ...
            String roleName = identityService.createGroupQuery().groupId(expressionText)
