...
public class ActUtils {
    ...
    public static String getFormUrl(String formKey, Act act) {
        ...
        formUrl.append("&act.taskName=").append(
                act.getTaskName() != null ? Encodes.urlEncode(act.getTaskName()) : "");
            ...
            for (Method m : entity.getClass().getMethods()) {
                if ((m.getAnnotation(JsonIgnore.class) == null)
                    ...
                    if (m.getName().equals("getAct")) {
                        ...
                        field.add(org.apache.commons.lang3.StringUtils.uncapitalize(m.getName()
                                .substring(3)));
                        value.add(org.apache.commons.lang3.ObjectUtils.toString(
