...
public class ActUserEntityService extends UserEntityManager {
    ...
    public void deleteUser(String userId) {
        ...
        User user = findUserById(userId);
        if (user != null) {
            getSystemService().deleteUser(
                    new com.thinkgem.jeesite.modules.sys.entity.User(user.getId()));
        }
    }
    ...
    public List<Group> findGroupsByUser(String userId) {
        ...
        for (Role role : getSystemService().findRole(
                new Role(new com.thinkgem.jeesite.modules.sys.entity.User(null, userId)))) {
