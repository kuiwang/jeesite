...
public class GenUtils {
    ...
    public static String generateToFile(GenTemplate tpl, Map<String, Object> model,
        ...
        String fileName = Global.getProjectPath()
                ...
                + org.apache.commons.lang3.StringUtils.replaceEach(
                        FreeMarkers.renderString(tpl.getFilePath() + "/", model), new String[] {
        ...
        String content = FreeMarkers.renderString(
                org.apache.commons.lang3.StringUtils.trimToEmpty(tpl.getContent()), model);
    ...
    public static Map<String, Object> getDataModel(GenScheme genScheme) {
        ...
        model.put("packageName",
                org.apache.commons.lang3.StringUtils.lowerCase(genScheme.getPackageName()));
        model.put(
                "lastPackageName",
                org.apache.commons.lang3.StringUtils.substringAfterLast(
                        (String) model.get("packageName"), "."));
        model.put("moduleName",
                org.apache.commons.lang3.StringUtils.lowerCase(genScheme.getModuleName()));
        model.put("subModuleName",
                org.apache.commons.lang3.StringUtils.lowerCase(genScheme.getSubModuleName()));
        model.put("className", org.apache.commons.lang3.StringUtils.uncapitalize(genScheme
                .getGenTable().getClassName()));
        model.put("ClassName", org.apache.commons.lang3.StringUtils.capitalize(genScheme
                .getGenTable().getClassName()));

        model.put("functionName", genScheme.getFunctionName());
        model.put("functionNameSimple", genScheme.getFunctionNameSimple());
        model.put("functionAuthor", org.apache.commons.lang3.StringUtils.isNotBlank(genScheme
                .getFunctionAuthor()) ? genScheme.getFunctionAuthor() : UserUtils.getUser()
                .getName());
        ...
        model.put(
                ...
                model.get("moduleName")
                        + (org.apache.commons.lang3.StringUtils.isNotBlank(genScheme
                                .getSubModuleName()) ? "/"
                                + org.apache.commons.lang3.StringUtils.lowerCase(genScheme
                                        .getSubModuleName()) : "") + "/" + model.get("className"));
        ...
        if ((config != null) && (config.getCategoryList() != null) && (category != null)) {
            for (GenCategory e : config.getCategoryList()) {
                if (category.equals(e.getValue())) {
                    ...
                    if (list != null) {
                        for (String s : list) {
                            if (org.apache.commons.lang3.StringUtils.startsWith(s,
                                    GenCategory.CATEGORY_REF)) {
                                templateList.addAll(getTemplateList(config,
                                        org.apache.commons.lang3.StringUtils.replace(s,
                                                GenCategory.CATEGORY_REF, ""), false));
                            } else {
    ...
    public static void initColumnField(GenTable genTable) {
        for (GenTableColumn column : genTable.getColumnList()) {
            ...
            // 设置java类型
            if (org.apache.commons.lang3.StringUtils.startsWithIgnoreCase(column.getJdbcType(),
                    "CHAR")
                    || org.apache.commons.lang3.StringUtils.startsWithIgnoreCase(
                            column.getJdbcType(), "VARCHAR")
                    || org.apache.commons.lang3.StringUtils.startsWithIgnoreCase(
                            column.getJdbcType(), "NARCHAR")) {
                column.setJavaType("String");
            } else if (org.apache.commons.lang3.StringUtils.startsWithIgnoreCase(
                    column.getJdbcType(), "DATETIME")
                    || org.apache.commons.lang3.StringUtils.startsWithIgnoreCase(
                            column.getJdbcType(), "DATE")
                    || org.apache.commons.lang3.StringUtils.startsWithIgnoreCase(
                            column.getJdbcType(), "TIMESTAMP")) {
                column.setJavaType("java.util.Date");
                column.setShowType("dateselect");
            } else if (org.apache.commons.lang3.StringUtils.startsWithIgnoreCase(
                    column.getJdbcType(), "BIGINT")
                    || org.apache.commons.lang3.StringUtils.startsWithIgnoreCase(
                            column.getJdbcType(), "NUMBER")) {
                // 如果是浮点型
                String[] ss = org.apache.commons.lang3.StringUtils.split(
                        org.apache.commons.lang3.StringUtils.substringBetween(column.getJdbcType(),
                                "(", ")"), ",");
            ...
            if (!org.apache.commons.lang3.StringUtils.equalsIgnoreCase(column.getName(), "id")
                    && !org.apache.commons.lang3.StringUtils.equalsIgnoreCase(column.getName(),
                            "create_by")
                    && !org.apache.commons.lang3.StringUtils.equalsIgnoreCase(column.getName(),
                            "create_date")
                    && !org.apache.commons.lang3.StringUtils.equalsIgnoreCase(column.getName(),
            ...
            // 用户
            if (org.apache.commons.lang3.StringUtils.startsWithIgnoreCase(column.getName(),
                    "user_id")) {
            ...
            // 部门
            else if (org.apache.commons.lang3.StringUtils.startsWithIgnoreCase(column.getName(),
                    "office_id")) {
            ...
            // 创建者、更新者
                    ...
                    "create_by")
                    || org.apache.commons.lang3.StringUtils.startsWithIgnoreCase(column.getName(),
                            "update_by")) {
                column.setJavaType(User.class.getName());
            ...
            // 备注、内容
            else if (org.apache.commons.lang3.StringUtils.equalsIgnoreCase(column.getName(),
                    "remarks")
                    || org.apache.commons.lang3.StringUtils.equalsIgnoreCase(column.getName(),
                            "content")) {
